...
def count_country_frequency(affiliations):
    ...
    countries1 = countries.reset_index()
    countries1.columns = ["countries", "count"]
    countries1.to_csv("countries.csv")
    #
    return countries
...
def main(n_countries):
    ...
    countries = select_most_frequente_countries(countries, n_countries)
